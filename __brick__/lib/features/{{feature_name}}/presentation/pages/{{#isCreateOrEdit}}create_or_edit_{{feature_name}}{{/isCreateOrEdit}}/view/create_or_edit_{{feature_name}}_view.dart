...
import '../bloc/create_or_edit_{{feature_name}}_cubit.dart';
import '../bloc/create_or_edit_{{feature_name}}_state.dart';
...
class _CreateOrEditView{{feature_name.pascalCase()}}State extends State<CreateOrEdit{{feature_name.pascalCase()}}View> {
  ...
  @override
  void initState() {
    _cubit = context.read<CreateOrEdit{{feature_name.pascalCase()}}Cubit>();
    super.initState();
